...
for i in range(10):
    count += 1
    print(f"\nepisode {count}\n")
    video_path = '/home/elegantai/Alldea/Collm/CoDrivingLLM/llm_controller/video/' + str(i) + '.mp4' 
    writer = imageio.get_writer(video_path, fps=240) 
    ...
    while not (terminated):
        ...
        obs, global_reward, terminated, info = env.step(tuple(action))
